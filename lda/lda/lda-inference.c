...
double lda_inference(document* doc, lda_model* model, double* var_gamma, double** phi)
{
	...
	double * oldphi = malloc(sizeof(double) * model->num_topics);
    int k, n, var_iter;
    double *digamma_gam = malloc(sizeof(double) * model->num_topics);
...
compute_likelihood(document* doc, lda_model* model, double** phi, double* var_gamma)
{
	...
	double * dig = malloc(sizeof(double) * model->num_topics);
    int k, n;
