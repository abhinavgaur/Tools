...
## 矩阵文件格式转换工具
### 说明
脚本文件：matrixconvert.cssc  
授权协议：LGPL

### 用法

> `cssc matrixconvert [lda2lsa|lsa2lda|lsa2lda2|lsa2fmat] <input> <output>`
...
- lsa2fmat: 将 LSA 的输入格式（完整的矩阵）转换为带大小说明的输入格式。
...
### 用法
> `cssc tfidf <dict> <input> <output> [tf]  
cssc tfidf <input> <output dict> [tf]`
