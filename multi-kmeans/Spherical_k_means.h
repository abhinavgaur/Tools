/*   Spherical k-means header file
     Spherical_k_means.h
     Copyright (c) 2001, Yuqiang Guan
*/

#if !defined(_SPHERICAL_K_MEANS_H_)
#define _SPHERICAL_K_MEANS_H_

#include "Gmeans.h"
#include "mat_vec.h"

class Spherical_k_means : public Gmeans
{
 public:
  Spherical_k_means(Matrix *p_docs, int cluster[], int ini_num_clusters, int est_start, float Omiga, bool random_seeding, int seed, float epsilon);
 protected:
...
#endif // !defined(_SPHERICAL_K_MEANS_H_)
